...
export default function EthnicCollection() {
  ...
  // Filter products that are in ethnic collection
  const ethnicProducts = products.filter(p => p.collection?.includes('ethnic'))

  return (
    <>
      <Head>
        <title>Ethnic Wear - Libra</title>
        <meta name="description" content="Explore Libra's collection of ethnic wear. Traditional styles with modern elegance." />
      </Head>
        ...
        <div className="container mx-auto px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 mt-6">
            ...
            <div className="flex-1 min-w-0">
              <div className="mb-8">
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-3 tracking-tight">Ethnic Wear</h1>
                <p className="text-gray-700 text-base leading-relaxed">
                  Celebrate tradition with our ethnic wear collection. Where heritage meets contemporary fashion.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-8 pb-4 border-b border-gray-200 gap-4">
                <div className="text-gray-700 text-sm font-medium">
                  {ethnicProducts.length} Products
                </div>
              ...
              <ProductGrid products={ethnicProducts} />
            </div>
          </div>
        </div>
