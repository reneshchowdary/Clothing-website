...
export default function NewArrivalsCollection() {
  ...
  return (
    <>
      <Head>
        <title>New Arrivals - Libra</title>
        <meta name="description" content="Discover the latest new arrivals at Libra. Fresh styles and trending fashion for women." />
      </Head>
        ...
        <div className="container mx-auto px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 mt-6">
            ...
            <div className="flex-1 min-w-0">
              <div className="mb-8">
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-3 tracking-tight">New Arrivals</h1>
                <p className="text-gray-700 text-base leading-relaxed">
                  Discover the latest trends and fresh styles. Shop our newest collection of women's fashion.
                </p>
              </div>
